            ...
            <div class="container-fluid">
                <div class="bg-white">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12">
                        <button onclick="window.location.href='add_visa_rate.php'" type="btn" class="btn btn-success">Add New Visa Price</button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <thead>
                            <tr>
                                <th class="table-dark">Visa Name</th>
                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td>
                                    <a class='btn btn-danger' href = 'delete_visa_info.php?ti=$row[visarate_id]'>Delete
                                    </td>
