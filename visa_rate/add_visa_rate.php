...
<div class="content-wrapper">
            <div class="container-fluid">
                <div class="bg-white">
                    ...
                    <form action="visa_rate_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4 col-sm-12">
                                            
                        <label for="visaname">Visa Name: </label>
                        <input type="text" name="visaname" class="form-control"><br>

                        <label for="visaprice">Visa Price : </label>
                        <input type="int" name="visaprice" class="form-control"><br>
