...
<div class="content-wrapper">
        <div class="container-fluid">
            <div class="bg-white">
                ...
                <form action="update_payment_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-5 col-sm-12">
                        <input type="hidden" name="payment_id" class="form-control" value="<?php echo "$pi" ?>"><br>
                        <label for="customerphone">Phone: </label>
                        <input type="int" name="customerphone" class="form-control" value="<?php echo "$cph" ?>"><br>

                        <label for="customername">Customer Name: </label>
                        <input type="text" name="customername" class="form-control" value="<?php echo "$cnm" ?>"><br>

                        <label for="customeremail">Email: </label>
                        <input type="email" name="customeremail" class="form-control" value="<?php echo "$cem" ?>"><br>

                        <label for="passportno">Passport No: </label>
                        <input type="int" name="passportno" class="form-control" value="<?php echo "$pno" ?>"><br>

                        <label for="customeraddress">Address: </label>
                        <input type="text" name="customeraddress" class="form-control" value="<?php echo "$add" ?>"><br>
                        ...
                        <label for="agentname">Select Agent:</label>
                        <select id="agentname" name="agentname" class="form-control">
                        <option value="<?php echo "$agn" ?>"><?php echo "$agn" ?></option>
                        <?php
                        ...
                        <option  value="<?php echo $row['agentname'];?>"><?php echo $row['agentname'];?></option>
                        ...
                        <label for="agentcost">Agent Cost: </label>
                        <input type="number" name="agentcost" class="form-control" value="<?php echo "$agc" ?>"><br>

                        
                        <label for="clientcharge">Client Charge: </label>
                        <input type="number" name="clientcharge" class="form-control" value="<?php echo "$cc" ?>"><br>

                      
                        <label for="sname">Service Name: </label>
                        <input type="text" name="sname" class="form-control" value="<?php echo "$snm" ?>"><br>
