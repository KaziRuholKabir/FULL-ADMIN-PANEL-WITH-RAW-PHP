    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <div class="bg-white">
                ...
                <form action="other_service_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <input type="number" name="agentcost" class="form-control"><br>

                        
                        <label for="clientcharge">Client Charge: </label>
                        <input type="number" name="clientcharge" class="form-control"><br>
