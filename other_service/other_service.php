        ...
        <div class="container-fluid">
            <div class="bg-white">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-12">
                    <button onclick="window.location.href='add_new_service.php'" type="btn" class="btn btn-success">Add New Service</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">

                        <h6>Other Service Table</h6>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="table-dark">Sevice Name</th>
                                <th class="table-dark">Agent</th>
                                <th class="table-dark">Description</th>
                                <th class="table-dark">Client Charge </th>
                                <th class="table-dark">Buttons</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td>".$row["clientcharge"]."</td>
                                    <td><a href = 'update_service_info.php?pi= $row[othser_id]&cph=$row[customerphone]&cnm=$row[customername]&cem=$row[customeremail]&pno=$row[passportno]&add=$row[customeraddress]&pcp=$row[passportcopy]&agn=$row[agentname]&agc=$row[agentcost]&cc=$row[clientcharge]&idt=$row[issuedate]&snm=$row[sname]&des=$row[description]'>Edit</td>
                                    </tr>";
                                }
                            }
                            }
