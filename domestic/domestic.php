                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    echo "<tr>                
                                    <td>". $row["agentname"]."</td>
                                    <td>".$row["balancedom"]."</td>
                                    <td>".$row["issuedate"]."</td>
                                   
                                    <td><a href = 'add_balance_info.php?di= $row[domt_id]&agn=$row[agentname]&bdm=$row[balancedom]&idt=$row[issuedate]'>Add Balance</td>
                                    </tr>";
                                }
                            }
                            }
