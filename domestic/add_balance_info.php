            ...
            <div class="bg-white">
                <div class="row">
                    <div class="col-lg-4 col-sm-12">
                        <h4>Add Balance to <?php echo "$agn" ?></h4>  
                    </div>
                    <div class="col-4">
                    </div>
                    <div class="col-4">
                ...
                <form action="add_balance_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                        <input type="hidden" name="domt_id" class="form-control" value="<?php echo "$di" ?>"><br>

                        <label for="vouchernodom">Voucher no: </label>
                        <input type="int" name="vouchernodom" class="form-control"><br>
                        ...
                        <input type="int" name="chequeno" class="form-control" value="<?php echo "$pno" ?>"><br>


                        <label for="accountno">Account No: </label>
                        <input type="int" name="accountno" class="form-control" value="<?php echo "$pno" ?>"><br>
                        ...
                        <input type="submit" name="submit" value="Add Balance" class="btn btn-success">
