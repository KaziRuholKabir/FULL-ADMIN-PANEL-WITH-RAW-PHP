            ...
            if(isset($_POST['submit']))
                {    
                    ...
                    if(in_array($passportcopy_ex_lc, $allowed_exs)){
                        ...
                        $sql = "UPDATE `advancepayment` SET customerphone = '$_POST[customerphone]',customername = '$_POST[customername]',customeremail = '$_POST[customeremail]',passportno = '$_POST[passportno]',customeraddress = '$_POST[customeraddress]',refname = '$_POST[refname]',description = '$_POST[description]',voucherno = '$_POST[voucherno]',amount = '$_POST[amount]',paymethod = '$_POST[paymethod]',issuedate = '$_POST[issuedate]',passportcopy = '$new_nid_name' where payment_id='$_POST[payment_id]' ";
                ...
                if(isset($_POST['delete']))
                {
                    ...
                    $query = "DELETE FROM advancepayment where payment_id='$payment_id' ";
                    //Data delete query
