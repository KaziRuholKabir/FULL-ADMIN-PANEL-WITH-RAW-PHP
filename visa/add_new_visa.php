                    ...
                    <li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="left-menu-dp">
                                <li><a href="../international_ticket/ticket_int.php"><i class="far fa-file-alt"></i>Ticket</a></li>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="bg-white">
                    ...
                    <form action="visa_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <label for="users">Visa Type: </label><br>

                        <select id="users" name="users" onchange="showUser(this.value)"  class="form-control">
                        <option value=""></option>
                        <?php
                        $conn = mysqli_connect("localhost","root","","himu");
                        $sql = "SELECT * FROM visarate";
                        $result = mysqli_query($conn, $sql);
                        while($row = mysqli_fetch_array($result)){
                        
                        ?>
                        
                        <option  value="<?php echo $row['visarate_id'];?>"><?php echo $row['visaname'];?></option>
                        ...
                        <label for="visaprice">Visa Price: </label>
                        <h4 id="txtHint"></h4>
