            ...
            <div class="container-fluid">
                <div class="bg-white">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12">
                        <button onclick="window.location.href='add_new_visa.php'" type="btn" class="btn btn-success">Add New Visa</button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="table-dark">Bill</th>
                                <th class="table-dark">Agent Name</th>
                                <th class="table-dark">Passport No</th>
                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td><a href = 'update_visa_info.php?vi= $row[visa_id]&cph=$row[customerphone]&cnm=$row[customername]&cem=$row[customeremail]&pn=$row[passportno]&cad=$row[customeraddress]&pcp=$row[passportcopy]&agn=$row[agentname]&vt=$row[visatype]&cb=$row[clientbill]&idt=$row[issuedate]>Edit</td>
                                    </tr>";
                                }
                            }
                            }
