        ...
        <div class="container-fluid">
            <div class="bg-white">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-12">
                    <button onclick="window.location.href='add_advance_payment.php'" type="btn" class="btn btn-success">Add New Payment</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">

                        <h6>Advance Payment Table</h6>
                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                $sql = "SELECT *  FROM advancepayment";
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td>".$row["paymethod"]."</td>
                                    <td><a href = 'update_payment_info.php?pi= $row[payment_id]&cph=$row[customerphone]&cnm=$row[customername]&cem=$row[customeremail]&pno=$row[passportno]&add=$row[customeraddress]&pcp=$row[passportcopy]&ref=$row[refname]&des=$row[description]&vn=$row[voucherno]&am=$row[amount]&pmd=$row[paymethod]&idt=$row[issuedate]'>Edit</td>
                                    </tr>";
                                }
                            }
                            }
