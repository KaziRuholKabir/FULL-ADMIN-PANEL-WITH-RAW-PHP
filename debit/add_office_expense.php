    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <div class="bg-white">
                ...
                <form action="expense_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                                            
                        <label for="authorname">Author Name: </label>
                        <input type="text" name="authorname" class="form-control"><br>
                        ...
                        <input type="text" name="voucherno" class="form-control"><br>

                        <label for="amount">Amount: </label>
                        <input type="int" name="amount" class="form-control"><br>
                        ...
                        <input type="int" name="bacc"id="bacc"  class="form-control" disabled="true" ><br>
