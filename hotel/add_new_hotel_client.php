            ...
            <div class="container-fluid">
                <div class="bg-white">
                    ...
                    <div class="row">
                        ...
                        <input type="text" name="hotelname" class="form-control"><br><br>
                        ...
                        <select id="ticketagent" name="ticketagent" class="form-control">
                            <option value="Domestic Agent">Kamal</option>
                        ...
                        <input type="number" name="debit" class="form-control"><br>

                        
                        <label for="description">Description: </label><br>
                        <input type="text" name="description" class="form-control"><br>

                        <label for="agentbill">Agent Bill: </label>
                        <input type="number" name="agentbill" class="form-control"><br>
