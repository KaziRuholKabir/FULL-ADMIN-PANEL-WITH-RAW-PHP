        ...
        <div class="container-fluid">
            <div class="bg-white">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-12">
                    <button onclick="window.location.href='add_new_hotel_client.php'" type="btn" class="btn btn-success">Add New Hotel Client</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="table-dark">Name of Hotel</th>
                                <th class="table-dark">City</th>
                                <th class="table-dark">Paid</th>
                                <th class="table-dark">Debit</th>
                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td>".$row["hotelname"]."</td>
                                    <td>".$row["cityname"]."</td>
                                    <td>".$row["clientbill"]."</td>
                                    <td>".$row["debit"]."</td>
                                    <td><a href = 'update_ticket_info.php?bi=$row[booking_id]&cph=$row[customerphone]&cnm=$row[customername]&cem=$row[customeremail]&pn=$row[passportno]&cad=$row[customeraddress]&tag=$row[ticketagent]&hn=$row[hotelname]&cn=$row[cityname]&cr=$row[credit]&deb=$row[debit]&des=$row[description]&ab=$row[agentbill]&cb=$row[clientbill]&idt=$row[issuedate]&pc=$row[passportcopy]'>Edit</td>
                                    </tr>";
                                }
                            }
                            }
