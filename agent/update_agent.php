        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="bg-white">
                    ...
                    <form action="update_agent_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4 col-sm-12">
                        <input type="hidden" name="agent_id" class="form-control" value="<?php echo "$ai" ?>"><br>
                        <label for="agentname">Agent Name: </label>
                        <input type="text" name="agentname" class="form-control"  value="<?php echo "$anm" ?>"><br>

                        <label for="agentaddress">Address: </label>
                        <input type="text" name="agentaddress" class="form-control"  value="<?php echo "$ad" ?>"><br>

                        <label for="international">Select Type: </label>
                        <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Active" name="international">
                        <label class="form-check-label" for="flexCheckDefault">
                        International
                        </label>
                        </div>
                        <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Active" name="domestic">
                    ...
                    <br>
                        ...
                        <input type="int" name="agentphone" class="form-control"  value="<?php echo "$aph" ?>"><br>



                        <label for="agenttype">Agent Type:</label>
                        <select id="agentType" name="agenttype" class="form-control">
                            <option value="<?php echo "$agt" ?>"><?php echo "$agt" ?></option>
                        ...
                        <input type="submit" name="delete" value="Delete Agent" class="btn btn-danger">
                        <br>
                        <br>
                        <br>
                        <br>
