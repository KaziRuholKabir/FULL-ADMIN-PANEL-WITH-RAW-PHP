            ...
            <div class="container-fluid">
                <div class="bg-white">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12">
                        <button onclick="window.location.href='add_agent.php'" type="btn" class="btn btn-success">Add New Agent</button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="table-dark">Agent Type</th>
                                <th class="table-dark">International</th>
                                <th class="table-dark">Domestic</th>
                        ...
                        if($conn->connect_error){
                            ...
                            $sql = "SELECT * FROM agent";
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td><a href = 'update_agent.php?ai=$row[agent_id]&anm=$row[agentname]&aph=$row[agentphone]&ad=$row[agentaddress]&agt=$row[agenttype]&int=$row[international]&dom=$row[domestic]'>Edit</td>
                                    </tr>";
                                }
                            }
                            }
