        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="bg-white">
                    ...
                    <form action="agent_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4 col-sm-12">
                        <label for="agentName">Agent Name: </label>
                        <input type="text" name="agentName" class="form-control"><br>
                        <label for="agentAddress">Address: </label>
                        <input type="text" name="agentAddress" class="form-control"><br>
                    ...
                    <br>
                        ...
                        <input type="int" name="agentPhone" class="form-control"><br>
