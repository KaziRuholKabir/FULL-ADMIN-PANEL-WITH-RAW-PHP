        ...
        <div class="container-fluid">
            <div class="bg-white">
                ...
                <div class="row">
                    ...
                    <input type="text" name="psaddress" class="form-control"><br>

                    <label for="praddress">Permanent Address: </label>
                    <input type="text" name="praddress" class="form-control"><br>
                    ...
                    <input type="int" name="phone2" class="form-control"><br>
                    <label for="phone3">Optional Phone: </label>
                    <input type="int" name="phone3" class="form-control"><br>
                    <label for="phone4">Optional Phone: </label>
                    <input type="int" name="phone4" class="form-control"><br>
