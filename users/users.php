        ...
        <div class="container-fluid">
            <div class="bg-white">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-12">
                    <button onclick="window.location.href='add_new_user.php'" type="btn" class="btn btn-success">Add New User</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="table-dark">designation</th>
                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                $sql = "SELECT user_id, username, email, phone, role, psAddress, prAddress, designation, salary, phone2, phone3, phone4  FROM user_info";
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td>".$row["salary"]."</td>
                                    <td><a href = 'update_user_info.php?ui= $row[user_id]&nm=$row[username]&em=$row[email]&ph=$row[phone]&rl=$row[role]&ps=$row[psAddress]&pr=$row[prAddress]&ds=$row[designation]&sl=$row[salary]&ph2=$row[phone2]&ph3=$row[phone3]&ph4=$row[phone4]'>Edit</td>
                                    </tr>";
                                }
                            }
                            }
