        ...
        <div class="container-fluid">
            <div class="bg-white">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-12">
                    <button onclick="window.location.href='add_manual_deposit.php'" type="btn" class="btn btn-success">Add New Deposit</button>
                    </div>
                </div>
                <div class="row">
                        ...
                        if($conn->connect_error){
                            die('Connection Failed : '.$conn->connect_error);
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td><a href = 'update_deposit_info.php?eid= $row[deposit_id]&anm=$row[authorname]&ref=$row[refname]&vno=$row[voucherno]&amn=$row[amount]&des=$row[description]&meth=$row[paymethod]&bnk=$row[bname]&bac=$row[bacc]'>Update Deposit</td>
                                    </tr>";
                                }
                            }
                            }
