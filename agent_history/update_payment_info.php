            ...
            <div class="bg-white">
                ...
                <form action="update_payment_submit.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <input type="text" name="voucherno" class="form-control" value="<?php echo "$vn" ?>"><br>

                        <label for="amount">Amount: </label>
                        <input type="number" name="amount" class="form-control" value="<?php echo "$am" ?>"><br>
                        ...
                        <select id="paymethod" name="paymethod" class="form-control">
                            ...
                            <option value="<?php echo "$pmd" ?>"><?php echo "$pmd" ?></option>
