                ...
                {    
                   ...
                   // $passportcopy = $_POST['passportcopy'];//add photo
                    ...
                    if(in_array($passportcopy_ex_lc, $allowed_exs)){
                        ...
                        $sql = "INSERT INTO domestic (customerphone,customername,customeremail,passportno,customeraddress,passportcopy,ticketagent,ticketno,sector,segment,traveldate,grossfare,basefare,commission,ait,clientbill,due,paid,servicecharge,discount,exprofit,netpay,issuedate)
