            ...
            <div class="container-fluid">
                <div class="bg-white">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12">
                        <button onclick="window.location.href='add_bank.php'" type="btn" class="btn btn-success">Add Bank Details</button>
                        </div>
                    </div>
                        ...
                        if($conn->connect_error){
                            ...
                            $sql = "SELECT * FROM bank_details";
                                ...
                                while ($row = $result-> fetch_assoc()){
                                    ...
                                    <td>".$row["accountno"]."</td>
                                    <td>".$row["balance"]."</td>
                                    <td><a href = 'update_bank_info.php?bi= $row[bank_id]&bnm=$row[bankname]&bac=$row[accountno]&bal=$row[balance]'>Edit</td>
                                    </tr>";
                                }
                            }
                            }
